class Path {
  ...
  static USER_PATH = `${process.env.REACT_APP_BASE_PATH}/user`;
  static USER_EDIT_PATH = `${process.env.REACT_APP_BASE_PATH}/user_edit`;
  static SIGNIN_PATH = `${process.env.REACT_APP_BASE_PATH}/signin`;
}
